...
namespace YCQL.SQLFunctions
{
	...
	public class SQLFunctionATan : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionATan class using specified column
		/// </summary>
		/// <param name="column">Column which ATan should be applied to</param>
		public SQLFunctionATan(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionATan class using specified expression
		/// </summary>
		/// <param name="expression">Expression which ATan should be applied to</param>
		public SQLFunctionATan(object expression)
			: base("ATAN", expression)
		{
		}
	}
}
