...
{
	/// <summary>
	/// Represents Right function in Sql
	/// </summary>
	...
	public class SqlFunctionRight : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionRight class using specified column and length
		/// </summary>
		/// <param name="column">Column which Right should be applied to</param>
		/// <param name="length">Number of characters should be returned</param>
		public SqlFunctionRight(DbColumn column, int length)
			: this((object) column, length)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionRight class using specified expression and length
		/// </summary>
		/// <param name="expression">Expression which Right should be applied to</param>
		/// <param name="length">Number of characters should be returned</param>
		public SqlFunctionRight(object expression, int length)
			: base("RIGHT", expression, length)
		{
		}
	}
}