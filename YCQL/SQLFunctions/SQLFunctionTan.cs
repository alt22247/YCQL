...
{
	/// <summary>
	/// Represents Tan function in Sql
	/// </summary>
	...
	public class SqlFunctionTan : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionTan class using specified column
		/// </summary>
		/// <param name="column">Column which Tan should be applied to</param>
		public SqlFunctionTan(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionTan class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Tan should be applied to</param>
		public SqlFunctionTan(object expression)
			: base("TAN", expression)
		{
		}
	}
