...
{
	/// <summary>
	/// Represents Log function in Sql
	/// </summary>
	...
	public class SQLFunctionLog : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionLog class using specified column
		/// </summary>
		/// <param name="column">Column which Log should be applied to</param>
		public SQLFunctionLog(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionLog class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Log should be applied to</param>
		public SQLFunctionLog(object expression)
			: base("LOG", expression)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionLog class using specified column and log base
		/// </summary>
		/// <param name="column">Column which Log should be applied to</param>
		/// <param name="logBase">The base for the log function</param>
		public SQLFunctionLog(DBColumn column, float logBase)
			: this((object) column, logBase)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionLog class using specified expression and log base
		/// </summary>
		/// <param name="expression">Expression which Log should be applied to</param>
		/// <param name="logBase">The base for the log function</param>
		public SQLFunctionLog(object expression, float logBase)
			: base("LOG", expression, logBase)
		{
		}
	}
}