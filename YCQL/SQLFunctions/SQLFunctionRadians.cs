...
{
	/// <summary>
	/// Represents Radians function in Sql
	/// </summary>
	...
	public class SQLFunctionRadians : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionRadians class using specified column
		/// </summary>
		/// <param name="column">Column which Radians should be applied to</param>
		public SQLFunctionRadians(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionRadians class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Radians should be applied to</param>
		public SQLFunctionRadians(object expression)
			: base("RADIANS", expression)
		{
		}
	}
}