...
{
	/// <summary>
	/// Represents Exp function in Sql
	/// </summary>
	...
	public class SQLFunctionExp : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionExp class using specified column
		/// </summary>
		/// <param name="column">Column which Exp should be applied to</param>
		public SQLFunctionExp(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionExp class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Exp should be applied to</param>
		public SQLFunctionExp(object expression)
			: base("EXP", expression)
		{
		}
	}
