...
{
	/// <summary>
	/// Represents Min aggregate function in Sql
	/// </summary>
	...
	public class SqlFunctionMin : SQLAggregateFunctionBase<SqlFunctionMin>
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionMin class using specified column
		/// </summary>
		/// <param name="column">Column which Min should be applied to</param>
		public SqlFunctionMin(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionMin class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Min should be applied to</param>
		public SqlFunctionMin(object expression)
			: base("MIN", expression)
		{
		}
	}
