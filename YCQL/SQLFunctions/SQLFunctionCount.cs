...
{
	/// <summary>
	/// Represents Count aggregate function in Sql
	/// </summary>
	...
	public class SqlFunctionCount : SQLAggregateFunctionBase<SqlFunctionCount>
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionCount class. COUNT(*) will be generated
		/// </summary>
		public SqlFunctionCount()
			: this(new SqlAllColumnSymbol())
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionCount class using specified column
		/// </summary>
		/// <param name="column">Column to be counted</param>
		public SqlFunctionCount(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionCount class using specified expression
		/// </summary>
		/// <param name="expression">Expression to be counted</param>
		public SqlFunctionCount(object expression)
