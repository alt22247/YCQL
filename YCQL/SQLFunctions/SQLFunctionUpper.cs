...
{
	/// <summary>
	/// Represents Upper function in Sql
	/// </summary>
	...
	public class SQLFunctionUpper : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionUpper class using specified column
		/// </summary>
		/// <param name="column">Column which Upper should be applied to</param>
		public SQLFunctionUpper(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionUpper class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Upper should be applied to</param>
		public SQLFunctionUpper(object expression)
			: base("UPPER", expression)
		{
		}
	}
}