...
{
	/// <summary>
	/// Represents Avg aggregate function in Sql
	/// </summary>
	...
	public class SqlFunctionAvg : SQLAggregateFunctionBase<SqlFunctionAvg>
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionAvg class using specified column
		/// </summary>
		/// <param name="column">Column which Avg should be applied to</param>
		public SqlFunctionAvg(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionAvg class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Avg should be applied to</param>
		public SqlFunctionAvg(object expression)
			: base("AVG", expression)
		{
		}
	}
