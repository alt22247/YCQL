...
{
	/// <summary>
	/// Represents Sqrt function in Sql
	/// </summary>
	...
	public class SQLFunctionSqrt : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionSqrt class using specified column
		/// </summary>
		/// <param name="column">Column which Sqrt should be applied to</param>
		public SQLFunctionSqrt(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionSqrt class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Sqrt should be applied to</param>
		public SQLFunctionSqrt(object expression)
			: base("SQRT", expression)
		{
		}
	}
}
