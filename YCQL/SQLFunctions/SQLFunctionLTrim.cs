...
{
	/// <summary>
	/// Represents LTrim(left trim) function in Sql
	/// </summary>
	...
	public class SQLFunctionLTrim : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionLTrim class using specified column
		/// </summary>
		/// <param name="column">Column to be right trimmedo</param>
		public SQLFunctionLTrim(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionLTrim class using specified expression
		/// </summary>
		/// <param name="expression">Expression to be right trimmed</param>
		public SQLFunctionLTrim(object expression)
			: base("LTRIM", expression)
		{
		}
	}
}