...
{
	/// <summary>
	/// Represents Sum aggregate function in Sql
	/// </summary>
	...
	public class SqlFunctionSum : SQLAggregateFunctionBase<SqlFunctionSum>
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionSum class using specified column
		/// </summary>
		/// <param name="column">Column which Sum should be applied to</param>
		public SqlFunctionSum(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionSum class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Sum should be applied to</param>
		public SqlFunctionSum(object expression)
			: base("SUM", expression)
		{
		}
	}
