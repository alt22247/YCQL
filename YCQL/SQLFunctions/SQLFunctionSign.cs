...
{
	/// <summary>
	/// Represents Sign function in Sql
	/// </summary>
	...
	public class SQLFunctionSign : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionSign class using specified column
		/// </summary>
		/// <param name="column">Column which Sign should be applied to</param>
		public SQLFunctionSign(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionSign class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Sign should be applied to</param>
		public SQLFunctionSign(object expression)
			: base("SIGN", expression)
		{
		}
	}
}