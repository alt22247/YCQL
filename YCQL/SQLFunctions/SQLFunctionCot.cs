...
{
	/// <summary>
	/// Represents Cot function in Sql
	/// </summary>
	...
	public class SqlFunctionCot : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionCot class using specified column
		/// </summary>
		/// <param name="column">Column which Cot should be applied to</param>
		public SqlFunctionCot(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionCot class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Cot should be applied to</param>
		public SqlFunctionCot(object expression)
			: base("COT", expression)
		{
		}
	}
