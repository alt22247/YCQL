...
{
	/// <summary>
	/// Represents Lower function in Sql
	/// </summary>
	...
	public class SqlFunctionLower : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionLower class using specified column
		/// </summary>
		/// <param name="column">Column which Lower should be applied to</param>
		public SqlFunctionLower(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionLower class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Lower should be applied to</param>
		public SqlFunctionLower(object expression)
			: base("LOWER", expression)
		{
		}
	}
}