...
{
	/// <summary>
	/// Represents base 10 log function in Sql
	/// </summary>
	...
	public class SqlFunctionLog10 : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionLog10 class using specified column
		/// </summary>
		/// <param name="column">Column which base 10 log should be applied to</param>
		public SqlFunctionLog10(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionLog10 class using specified expression
		/// </summary>
		/// <param name="expression">Expression which base 10 log should be applied to</param>
		public SqlFunctionLog10(object expression)
			: base("LOG10", expression)
		{
		}
	}
}