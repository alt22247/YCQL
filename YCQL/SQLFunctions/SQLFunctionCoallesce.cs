...
{
	/// <summary>
	/// Represents Coallesce function in Sql
	/// </summary>
	...
	public class SQLFunctionCoallesce : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionCoallesce class using specified expressions
		/// </summary>
		/// <param name="expressions">Expressions which Coallesce should be applied to</param>
		public SQLFunctionCoallesce(params object[] expressions)
			: base("COALESCE", expressions)
		{
		}
	}
}
