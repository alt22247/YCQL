...
{
	/// <summary>
	/// Represents Ceiling function in Sql
	/// </summary>
	...
	public class SqlFunctionCeiling : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionCeiling class using specified column
		/// </summary>
		/// <param name="column">Column which Ceiling should be applied to</param>
		public SqlFunctionCeiling(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionCeiling class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Ceiling should be applied to</param>
		public SqlFunctionCeiling(object expression)
			: base("CEILING", expression)
		{
		}
	}
}