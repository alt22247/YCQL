...
{
	/// <summary>
	/// Represents Char function in Sql
	/// </summary>
	...
	public class SQLFunctionChar : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionChar class using specified column
		/// </summary>
		/// <param name="column">Column which Char should be applied to</param>
		public SQLFunctionChar(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionChar class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Char should be applied to</param>
		public SQLFunctionChar(object expression)
			: base("CHAR", expression)
		{
		}
	}
}