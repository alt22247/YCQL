...
{
	/// <summary>
	/// Represents ACos function in Sql
	/// </summary>
	...
	public class SQLFunctionACos : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionACos class using specified column
		/// </summary>
		/// <param name="column">Column which ACos should be applied to</param>
		public SQLFunctionACos(DBColumn column)
			: this((object) column)
		{
		}
		...
		/// Initializes a new instance of the SQLFunctionACos class using specified column
		/// </summary>
		/// <param name="expression">Expression which ACos should be applied to</param>
		public SQLFunctionACos(object expression)
			: base("ACOS", expression)
		{
		}
	}
}