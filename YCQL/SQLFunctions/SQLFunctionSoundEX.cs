...
{
	/// <summary>
	/// Represents SoundEX function in Sql
	/// </summary>
	...
	public class SqlFunctionSoundEX : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionSoundEX class using specified column
		/// </summary>
		/// <param name="column">Column which SoundEX should be applied to</param>
		public SqlFunctionSoundEX(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionSoundEX class using specified expression
		/// </summary>
		/// <param name="expression">Expression which SoundEX should be applied to</param>
		public SqlFunctionSoundEX(object expression)
			: base("SOUNDEX", expression)
		{
		}
	}
}