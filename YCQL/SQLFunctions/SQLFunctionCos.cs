...
{
	/// <summary>
	/// Represents Cos function in Sql
	/// </summary>
	...
	public class SqlFunctionCos : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionCos class using specified column
		/// </summary>
		/// <param name="column">Column which Cos should be applied to</param>
		public SqlFunctionCos(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionCos class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Cos should be applied to</param>
		public SqlFunctionCos(object expression)
			: base("COS", expression)
		{
		}
	}
