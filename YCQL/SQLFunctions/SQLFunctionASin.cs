...
{
	/// <summary>
	/// Represents ASin function in Sql
	/// </summary>
	...
	public class SqlFunctionASin : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionASin class using specified column
		/// </summary>
		/// <param name="column">Column which ASin should be applied to</param>
		public SqlFunctionASin(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionASin class using specified expression
		/// </summary>
		/// <param name="expression">Expression which ASin should be applied to</param>
		public SqlFunctionASin(object expression)
			: base("ASIN", expression)
		{
		}
	}
}