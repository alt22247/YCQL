...
{
	/// <summary>
	/// Represents RTrim function in Sql
	/// </summary>
	...
	public class SQLFunctionRTrim : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionRTrim class using specified column
		/// </summary>
		/// <param name="column">Column to be right trimmed</param>
		public SQLFunctionRTrim(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionRTrim class using specified expression
		/// </summary>
		/// <param name="expression">Expression to be right trimmed</param>
		public SQLFunctionRTrim(object expression)
			: base("RTRIM", expression)
		{
		}
	}
}