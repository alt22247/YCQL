...
{
	/// <summary>
	/// Represents ASCII function in Sql
	/// </summary>
	...
	public class SQLFunctionASCII : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionASCII class using specified column
		/// </summary>
		/// <param name="column">Column which ASCII should be applied to</param>
		public SQLFunctionASCII(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionASCII class using specified expression
		/// </summary>
		/// <param name="expression">Expression which ASCII should be applied to</param>
		public SQLFunctionASCII(object expression)
			: base("ASCII", expression)
		{
		}
	}
}