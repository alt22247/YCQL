...
{
	/// <summary>
	/// Represents Reverse function in Sql
	/// </summary>
	...
	public class SqlFunctionReverse : SqlFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SqlFunctionReverse class using specified column
		/// </summary>
		/// <param name="column">Column to be reversed</param>
		public SqlFunctionReverse(DbColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SqlFunctionReverse class using specified expression
		/// </summary>
		/// <param name="expression">Expression to be reversed</param>
		public SqlFunctionReverse(object expression)
			: base("REVERSE", expression)
		{
		}
	}
}