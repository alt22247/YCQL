...
{
	/// <summary>
	/// Represents Sin function in Sql
	/// </summary>
	...
	public class SQLFunctionSin : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionSin class using specified column
		/// </summary>
		/// <param name="column">Column which Sin should be applied to</param>
		public SQLFunctionSin(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionSin class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Sin should be applied to</param>
		public SQLFunctionSin(object expression)
			: base("SIN", expression)
		{
		}
	}
