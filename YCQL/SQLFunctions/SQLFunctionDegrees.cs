...
{
	/// <summary>
	/// Represents Degrees function in Sql
	/// </summary>
	...
	public class SQLFunctionDegrees : SQLFunctionBase
	{
		/// <summary>
		/// Initializes a new instance of the SQLFunctionDegrees class using specified column
		/// </summary>
		/// <param name="column">Column which Degrees should be applied to</param>
		public SQLFunctionDegrees(DBColumn column)
			: this((object) column)
		{
		}

		/// <summary>
		/// Initializes a new instance of the SQLFunctionDegrees class using specified expression
		/// </summary>
		/// <param name="expression">Expression which Degrees should be applied to</param>
		public SQLFunctionDegrees(object expression)
			: base("DEGREES", expression)
		{
		}
	}
}